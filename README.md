...
```sh
curl -fsSL https://raw.githubusercontent.com/phongndo/hz/main/scripts/install.sh | HZ_VERSION=0.1.8 sh
...
```sh
hz update
hz update --target-version 0.1.8
```
...
```sh
cargo install --locked --git https://github.com/phongndo/hz --tag v0.1.8 hz-cli
```
