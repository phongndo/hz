...
pub use diff::{diff, github_pr_diff_options};
...
pub use worktree::{
    ...
    handoff_worktree, list_worktree_targets, list_worktrees, local_worktree, path_worktree,
    remove_found_worktree, remove_found_worktree_with_force, remove_worktree,
};
